...
|-----|-----------|---------------|-------------------|-------------------------|---------|
| 0   | simple    | MAP (rust)    | 1.070             | 0.730                   | 1.47x   |
| 1   | simple    | LSMR diagonal | 1.462             | 0.772                   | 1.89x   |
| 2   | simple    | LSMR additive | 2.460             | 0.895                   | 2.75x   |
| 3   | difficult | MAP (rust)    | 49.724            | 11.323                  | 4.39x   |
| 4   | difficult | LSMR diagonal | 5.939             | 1.713                   | 3.47x   |
| 5   | difficult | LSMR additive | 2.566             | 1.002                   | 2.56x   |
